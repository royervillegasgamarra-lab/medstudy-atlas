...
- **Database Test Suite (`supabase/tests/database/`)**: 190 pgTAP tests passing.
- **Unit & Integration Test Suite (`tests/unit/`, `tests/integration/`)**: 107 tests passing across 10 suites.
