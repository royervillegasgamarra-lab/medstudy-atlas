...
Adaptive medical learning platform engineered with evidence-based cognitive learning science, clinical knowledge modeling, and context-aware AI.
...
- **[Roadmap: Phase 0](docs/roadmap/phase-0.md)**: Overview of Phases 0A, 0B, and 0C.
- **[Deferred Scope](docs/roadmap/not-yet.md)**: Explicit list of features deferred to later phases.
- **[Current Status](docs/status.md)**: Real-time project snapshot and subsystem states.
- **[Architecture Decision Records (ADRs)](docs/adrs/README.md)**: Architecture decisions index.
